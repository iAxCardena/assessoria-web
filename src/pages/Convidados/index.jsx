...
import { Dialog, DialogActions, DialogContent, DialogTitle, Grid2, IconButton, TextField, Button, Tooltip, Divider, Tabs, Tab } from "@mui/material";
...
export default function Convidados() {
    ...
    const fillGuestDialogFields = (guest) => {
        ...
        setValue("newGuestName", guest.name)
    ...
    return(
        <Container>
            <Tipografia variante="h4" componente="h4">Lista de Convidados</Tipografia>
            <Botao style={{margin: '10px 0 0 0'}} variant={"contained"} onClick={() => openInvitationsPopup()}>Adicionar convite</Botao>
            <ListContainer backgroundcolor={COLOR_GREY[50]}>
                    ...
                    <StyledDialogContent>
                        ...
                        <Grid2 container spacing={2}>
                            <Grid2 size={{ xs: 3, sm: 3, md: 3 }}>
                                ...
                                />
                                {errors.ddi && <StyledErrorMessage variante={"legenda"} componente={"legenda"}>Campo obrigatório</StyledErrorMessage>}
                            </Grid2>
                            <Grid2 size={{ xs: 3, sm: 3, md: 3 }}>
                            ...
                            <Grid2 size={{ xs: 6, sm: 6, md: 6 }}>
                                ...
                                />
                                {errors.group && <StyledErrorMessage variante={"legenda"} componente={"legenda"}>Campo obrigatório</StyledErrorMessage>}
                            </Grid2>
                        </Grid2>
                ...
                <StyledDialogContent>
                    <Grid2 container spacing={2}>
                        ...
                        <Grid2 size={{ xs: 3, sm: 3, md: 3 }}>
                            ...
                            <RadioOptions value={rsvp}
                                onClick={setRsvp}
                                options={[
                                    {id: 1, value: "pending", label: <PriorityHighIcon/>, hint:'Pendente', color: COLOR_WARNING},
                                    {id: 2, value: "confirmed", label: <CheckIcon/>, hint:'Confirmado', color: COLOR_SUCCESS},
                                    {id: 3, value: "canceled", label: <CloseIcon/>, hint:'Cancelado', color: COLOR_ERROR}
                                ]}
                            />
                        </Grid2>
                    </Grid2>
                    <Grid2 container spacing={2}>
                        <Grid2 size={{ xs: 6, sm: 6, md: 6 }}>
                            ...
                            />
                            {errors.table && <StyledErrorMessage variante={"legenda"} componente={"legenda"}>Campo obrigatório</StyledErrorMessage>}
                        </Grid2>
                        <Grid2 size={{ xs: 6, sm: 6, md: 6 }}>
                    ...
                    <Grid2 container spacing={2}>
                        <Grid2 size={{ xs: 6, sm: 6, md: 6 }}>
                            ...
                            />
                            {errors.ageGroup && <StyledErrorMessage variante={"legenda"} componente={"legenda"}>Campo obrigatório</StyledErrorMessage>}
                        </Grid2>
                        <Grid2 size={{ xs: 6, sm: 6, md: 6 }}>
